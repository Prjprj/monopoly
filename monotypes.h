...
typedef enum{depart,terrain,gare,compagnie,chance,communaute,impot,prison,vide}attribut;
typedef enum{rose,bleu,violet,orange,rouge,jaune,vert,bleue}couleurpropriete;
typedef enum{positif, negatif, avance, recul, avancecase, anniversaire}typecarte; 
typedef struct{
	char intitule[80];
	typecarte type;
	int parametre;
