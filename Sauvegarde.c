...
void sauvegarde(Joueur *act){
	...
	do{
		boucle=0;
		printf("Entrez le nom du fichier ou vous voulez enregistrer votre partie\n");
		scanf("%s",reponse);
		...
		if(fichier!=NULL){
			...
			if(rep=='n'){
				printf("Pour entrer un nouveau nom de fichier appuyez sur n'importe quelle touche, sinonappuyez sur la touche Escape\n");
				rep=getch();
				boucle=1;
				if(rep==27){
					boucle=0;
...
int chargement(void){
	...
	do{
		boucle=0;
		printf("Entrez le nom du fichier a partir duquel vous voulez charger votre partie\n");
		scanf("%s",reponse);
		fichier=fopen(reponse,"r");
		if(fichier!=NULL){
		...
		/*Cas où le fichier ne peut être ouvert*/
			...
			printf("Pour entrer un nouveau nom de fichier appuyez sur n'importe quelle touche, sinon appuyez sur la touche Escape\n");
			rep=getch();
			boucle=1;
			if(rep==27){
				boucle=0;
