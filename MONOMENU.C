...
int menutour(Joueur *slayer, listeJoueur *stach, propriete *tabprop, int *tabcolor, station *tabstat, compagnies *tabcomp, int *replay){
	menu choice;
	int choum, choix;
...
void voirpossession(Joueur *slayer, propriete *tabprop, int *tabcolor, station *tabstat, compagnies *tabcomp){
	menu choix;
