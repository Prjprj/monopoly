...
void freememoire(void){
	switch(monoplayers.nombrejoueur){
		case 8 :{
			free(monoplayers.player1->suivant->suivant->suivant->suivant->suivant->suivant->suivant);
			}
		case 7 :{
			free(monoplayers.player1->suivant->suivant->suivant->suivant->suivant->suivant);
			}
		case 6 :{
