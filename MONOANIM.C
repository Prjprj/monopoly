...
void lignelettre0(char c[1],int x,int y, int longueur, WORD couleur, booleen paf)
{
	int i;
...
void lignelettre1(char c[1],int x,int y, int longueur,WORD couleur, booleen paf)
{
	int i;
...
void colonnelettre0(char c[1],int x,int y, int longueur,WORD couleur, booleen paf)
{
	int i;
...
void colonnelettre1(char c[1],int x,int y, int longueur, WORD couleur, booleen paf)
{
	int i;
...
void diagolettre(char c[1],int x,int y, int longueur,WORD couleur, booleen paf){
	int i;
	int j;
...
void diagolettre1(char c[1],int x,int y, int longueur,WORD couleur, booleen paf){
	int i;
	int j;
...
void affiche_nom (char nom[50],int x, int y, WORD couleur,booleen paf)
{
	...
	for(i=0; i<longueur; i++){
		switch(nom[i]){
			case 'A':A(6*i+x,y,couleur, paf);
				break;
			case 'B':B(6*i+x,y,couleur, paf);
				break;
			case 'C':C(6*i+x,y,couleur, paf);
				break;
			case 'D':D(6*i+x,y,couleur, paf);
				break;
			case 'E':E(6*i+x,y,couleur,paf);
				break;
			case 'F':F(6*i+x,y,couleur,paf);
				break;
			case 'G':G(6*i+x,y,couleur,paf);
				break;
			case 'H':H(6*i+x,y,couleur,paf);
				break;
			case 'I':I(6*i+x,y,couleur,paf);
				break;
			case 'J':J(6*i+x,y,couleur,paf);
				break;
			case 'K':K(6*i+x,y,couleur,paf);
				break;
			case 'L':L(6*i+x,y,couleur,paf);
				break;
			case 'M':M(6*i+x,y,couleur,paf);
				break;
			case 'N':N(6*i+x,y,couleur,paf);
				break;
			case 'O':O(6*i+x,y,couleur,paf);
				break;
			case 'P':P(6*i+x,y,couleur,paf);
				break;
			case 'Q':Q(6*i+x,y,couleur,paf);
				break;
			case 'R':R(6*i+x,y,couleur,paf);
				break;
			case 'S':S(6*i+x,y,couleur,paf);
				break;
			case 'T':T(6*i+x,y,couleur,paf);
				break;
			case 'U':U(6*i+x,y,couleur,paf);
				break;
			case 'V':V(6*i+x,y,couleur,paf);
				break;
			case 'W':W(6*i+x,y,couleur,paf);
				break;
			case 'X':X(6*i+x,y,couleur,paf);
				break;
			case 'Y':Y(6*i+x,y,couleur,paf);
				break;
			case 'Z':Z(6*i+x,y,couleur,paf);
				break;
			case '1':UN(6*i+x,y,couleur,paf);
				break;
			case '2':DEUX(6*i+x,y,couleur,paf);
				break;
			case '3':TROIS(6*i+x,y,couleur,paf);
				break;
		    case '4':QUATRE(6*i+x,y,couleur,paf);
				break;
			case '5':CINQ(6*i+x,y,couleur,paf);
				break;
			case '6':SIX(6*i+x,y,couleur,paf);
				break;
		    case '7':SEPT(6*i+x,y,couleur,paf);
				break;
			case '8':HUIT(6*i+x,y,couleur,paf);
				break;
		    case '9':NEUF(6*i+x,y,couleur,paf);
				break;
			case '0':ZERO(6*i+x,y,couleur,paf);
				break;
			case '@':EXCL(6*i+x,y,couleur,paf);
				break;
		}
...
void affiche_nom_joli (char nom[50],int x, int y, booleen paf)
{
	...
	for(i=0; i<longueur; i++){
		switch(nom[i]){
			case 'a':
			case 'A':A(6*i+x,y,colorLettreHasard(), paf);
				break;
			case 'b':
			case 'B':B(6*i+x,y,colorLettreHasard(), paf);
				break;
			case 'c':
			case 'C':C(6*i+x,y,colorLettreHasard(), paf);
				break;
			case 'd':
			case 'D':D(6*i+x,y,colorLettreHasard(), paf);
				break;
			case 'e':
			case 'E':E(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'f':
			case 'F':F(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'g':
			case 'G':G(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'h':
			case 'H':H(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'i':
			case 'I':I(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'j':
			case 'J':J(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'k':
			case 'K':K(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'l':
			case 'L':L(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'm':
			case 'M':M(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'n':
			case 'N':N(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'o':
			case 'O':O(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'p':
			case 'P':P(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'q':
			case 'Q':Q(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'r':
			case 'R':R(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 's':
			case 'S':S(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 't':
			case 'T':T(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'u':
			case 'U':U(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'v':
			case 'V':V(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'w':
			case 'W':W(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'x':
			case 'X':X(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'y':
			case 'Y':Y(6*i+x,y,colorLettreHasard(),paf);
				break;
			case 'z':
			case 'Z':Z(6*i+x,y,colorLettreHasard(),paf);
				break;
			case '1':UN(6*i+x,y,colorLettreHasard(),paf);
				break;
			case '2':DEUX(6*i+x,y,colorLettreHasard(),paf);
				break;
			case '3':TROIS(6*i+x,y,colorLettreHasard(),paf);
				break;
		    case '4':QUATRE(6*i+x,y,colorLettreHasard(),paf);
				break;
			case '5':CINQ(6*i+x,y,colorLettreHasard(),paf);
				break;
			case '6':SIX(6*i+x,y,colorLettreHasard(),paf);
				break;
		    case '7':SEPT(6*i+x,y,colorLettreHasard(),paf);
				break;
			case '8':HUIT(6*i+x,y,colorLettreHasard(),paf);
				break;
		    case '9':NEUF(6*i+x,y,colorLettreHasard(),paf);
				break;
			case '0':ZERO(6*i+x,y,colorLettreHasard(),paf);
				break;
			case '@':EXCL(6*i+x,y,colorLettreHasard(),paf);
				break;
		}
